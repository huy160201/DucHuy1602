...
<a href="index.php?controller=category&action=create" class="btn btn-primary"><i class="fa fa-plus">Thêm mới</i></a>
        ...
        <?php foreach ($categories as $category) : ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="index.php?controller=category&action=delete&id=<?php echo $category['id']; ?>" title="Xóa" onclick="return confirm('Bạn có chắc muốn xóa bản ghi này?')">
